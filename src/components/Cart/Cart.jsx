  ...
  return (
   ...
   <div className="flex justify-center items-center gap-2 my-3">
    ...
    <h2 className='text-4xl my-5'>Total Price <span className='text-main'>{cartDetails.data.totalCartPrice} EGP</span></h2>
      ...
      <button onClick={() => clearAllCart()} className='text-main  w-full text-right font-semibold cursor-pointer hover:underline my-1 pe-3'>Clear All <i class="fa-regular fa-trash-can"></i></button>
