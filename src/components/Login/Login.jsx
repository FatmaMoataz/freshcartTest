...
<span class="font-medium">  {ApiError}</span>
  ...
  {
LoginForm.errors.email && LoginForm.touched.email ?   <div class="p-2 mb-4 text-sm text-red-800 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400" role="alert">
<i class="fa-solid fa-circle-exclamation"></i>
<span class="font-medium">  {LoginForm.errors.email}</span>
</div> : ''
}
  <div className="relative z-0 w-full mb-5 group">
  ...
  {
LoginForm.errors.password && LoginForm.touched.password ?   <div class="p-2 mb-4 text-sm text-red-800 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400" role="alert">
<i class="fa-solid fa-circle-exclamation"></i>
<span class="font-medium">  {LoginForm.errors.password}</span>
</div> : ''
}

{
  ...
  </div> :   <button type="submit" className="text-white bg-main hover:bg-main focus:ring-4 focus:outline-none focus:ring-main font-medium rounded-lg text-sm block ml-auto w-full sm:w-auto  px-5 py-2.5 text-center dark:bg-main dark:hover:bg-main dark:focus:ring-main">Login</button>
